<?php $__env->startSection('title', 'Received Items'); ?>
<?php $__env->startSection('breadcrumb', 'Received Items'); ?>
...
<div class="bg-white rounded-lg shadow-sm">
    ...
    <div class="p-6 border-b border-gray-200">
        <div class="flex justify-between items-center mb-4">
            ...
            <div class="flex items-center space-x-3">
                <form method="GET" action="<?php echo e(route('customer.transfers.received')); ?>" class="flex items-center space-x-3">
        ...
        <div class="flex items-center space-x-4 text-sm">
            ...
            <a href="<?php echo e(route('customer.transfers.received')); ?>" 
               class="px-3 py-1 rounded-lg <?php echo e(!request('status') ? 'bg-blue-100 text-blue-700' : 'text-gray-600 hover:bg-gray-100'); ?>">
                All
            </a>
            <a href="<?php echo e(route('customer.transfers.received', ['status' => 'unread'])); ?>" 
               class="px-3 py-1 rounded-lg <?php echo e(request('status') == 'unread' ? 'bg-blue-100 text-blue-700' : 'text-gray-600 hover:bg-gray-100'); ?>">
                Unread
            </a>
            <a href="<?php echo e(route('customer.transfers.received', ['status' => 'read'])); ?>" 
               class="px-3 py-1 rounded-lg <?php echo e(request('status') == 'read' ? 'bg-blue-100 text-blue-700' : 'text-gray-600 hover:bg-gray-100'); ?>">
                Read
            </a>
        </div>
    </div>
    ...
    <div class="divide-y divide-gray-200">
        <?php $__empty_1 = true; $__currentLoopData = $transfers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transfer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="p-6 hover:bg-gray-50 transition-colors <?php echo e($transfer->is_viewed ? '' : 'bg-blue-50'); ?>">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center flex-1">
                        ...
                        <div class="flex-1">
                            <h3 class="font-semibold text-gray-900">
                                <?php echo e($transfer->file_name); ?>

                                <?php if(!$transfer->is_viewed): ?>
                                    <span class="ml-2 px-2 py-0.5 text-xs bg-blue-600 text-white rounded-full">New</span>
                                <?php endif; ?>
                            </h3>
                            <p class="text-sm text-gray-600">
                                From: <span class="font-medium"><?php echo e($transfer->senderUser->displayname ?? $transfer->sender_name); ?></span>
                                (<?php echo e($transfer->sender_vepost_addr); ?>)
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <form method="POST" action="<?php echo e(route('customer.transfers.destroy', $transfer->id)); ?>" class="inline">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/emilvaklinov/Desktop/eze.project/ezepost-app/resources/views/customer/transfers/received.blade.php ENDPATH**/ ?>