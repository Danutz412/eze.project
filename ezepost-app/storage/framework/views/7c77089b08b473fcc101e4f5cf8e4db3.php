...
<head>
    ...
    <title>Registration Information - <?php echo e(config('app.name', 'EzePost')); ?></title>
        ...
        <div class="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8">
            <div class="max-w-3xl w-full space-y-6 bg-white p-10 rounded-lg">
                ...
                <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center px-6 py-3 border border-transparent text-sm font-medium rounded-lg text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
...
<?php /**PATH /Users/emilvaklinov/Desktop/eze.project/ezepost-app/resources/views/auth/register-info.blade.php ENDPATH**/ ?>