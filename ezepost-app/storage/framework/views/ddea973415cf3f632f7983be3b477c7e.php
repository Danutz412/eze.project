<?php $__env->startSection('title', 'Received Today'); ?>
<?php $__env->startSection('breadcrumb', 'Received Today'); ?>

<?php $__env->startSection('content'); ?>
<div class="bg-white rounded-lg shadow-sm">
    <div class="p-6 border-b border-gray-200">
        <h2 class="text-2xl font-bold text-gray-900">Received Today</h2>
        <p class="text-sm text-gray-600 mt-1">Files received today: <?php echo e($transfers->total()); ?></p>
    </div>
    ...
    <div class="divide-y divide-gray-200">
        <?php $__empty_1 = true; $__currentLoopData = $transfers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transfer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="p-6 hover:bg-gray-50 transition-colors <?php echo e($transfer->is_viewed ? '' : 'bg-green-50'); ?>">
                <div class="flex items-center justify-between">
                    <div class="flex items-center flex-1">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-600">From: <?php echo e($transfer->senderUser->displayname ?? 'Unknown'); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-2">
                        <a href="<?php echo e(route('customer.transfers.download', $transfer)); ?>" class="p-2 text-green-600 hover:bg-green-50 rounded-lg">
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/emilvaklinov/Desktop/eze.project/ezepost-app/resources/views/customer/transfers/received-today.blade.php ENDPATH**/ ?>