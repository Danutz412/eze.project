        ...
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-lg font-semibold text-red-600">
                    <?php if(auth()->user()->ezepostUser && auth()->user()->ezepostUser->vepost_addr): ?>
                        <?php echo e(auth()->user()->ezepostUser->vepost_addr); ?>

                    <?php else: ?>
                        <?php echo e(strtolower(str_replace(' ', '', auth()->user()->name))); ?>@example.com#ezepost
                    <?php endif; ?>
                </p>
            </div>
        </div>
        ...
        <div class="flex-1">
            ...
            <div class="bg-white rounded-lg p-4 mb-4">
                <div class="text-center py-8">
                    ...
                    <a href="<?php echo e(route('pricing')); ?>" class="inline-block bg-red-600 hover:bg-red-700 text-white font-medium py-3 px-8 rounded-lg transition-colors">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $teams ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="bg-gray-50 rounded-lg p-4 flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div>
                        <span class="text-gray-700 font-medium"><?php echo e($team->name); ?></span>
                        <?php if($team->owner): ?>
                            <span class="text-sm text-gray-500 ml-2">Owner: <?php echo e($team->owner->name); ?></span>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="flex items-center space-x-2">
                    <span class="text-sm text-gray-600"><?php echo e($team->used_licenses); ?>/<?php echo e($team->total_licenses); ?> licenses</span>
                    <a href="<?php echo e(route('customer.teams.show', $team)); ?>" class="text-sm text-blue-600 hover:text-blue-800">View</a>
                </div>
            </div>
...
<div class="grid md:grid-cols-3 gap-6 mb-6">
        <div class="bg-white border-2 border-gray-200 rounded-2xl p-6">
            ...
            <p class="text-4xl font-bold text-blue-700"><?php echo e($sent); ?></p>
        ...
        <div class="bg-white border-2 border-gray-200 rounded-2xl p-6">
            ...
            <p class="text-4xl font-bold text-green-700"><?php echo e($received); ?></p>
        ...
        <div class="bg-white border-2 border-gray-200 rounded-2xl p-6">
            ...
            <p class="text-4xl font-bold text-purple-700"><?php echo e($viewed); ?></p>
    ...
    <div class="grid md:grid-cols-2 gap-6">
        <div class="bg-white border-2 border-gray-200 rounded-2xl p-6">
            ...
            <div class="space-y-3">
                <a href="<?php echo e(route('customer.transfers.create')); ?>" class="block p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                    <div class="flex items-center">
                ...
                <a href="<?php echo e(route('customer.transfers.sent')); ?>" class="block p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                    <div class="flex items-center">
                ...
                <a href="<?php echo e(route('customer.teams.settings')); ?>" class="block p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors">
                    <div class="flex items-center">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $recentActivity ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                        <div class="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0">
                            <?php if($activity->sender_user_id == auth()->id()): ?>
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium text-gray-900 truncate"><?php echo e($activity->file_name); ?></p>
                            <p class="text-xs text-gray-600">
                                <?php if($activity->sender_user_id == auth()->id()): ?>
                                    Sent to <?php echo e($activity->receiverUser->name ?? 'Unknown'); ?>

                                <?php else: ?>
                                    Received from <?php echo e($activity->senderUser->name ?? 'Unknown'); ?>

                                <?php endif; ?>
                            </p>
                            <p class="text-xs text-gray-500"><?php echo e($activity->created_at->diffForHumans()); ?></p>
                        </div>
                        <span class="px-2 py-1 text-xs rounded-full <?php if($activity->status == 'viewed'): ?> bg-purple-100 text-purple-700 <?php elseif($activity->status == 'received'): ?> bg-green-100 text-green-700 <?php else: ?> bg-blue-100 text-blue-700 <?php endif; ?>">
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/emilvaklinov/Desktop/eze.project/ezepost-app/resources/views/customer/dashboard.blade.php ENDPATH**/ ?>