...
@section('breadcrumb', 'Billing Portal')
...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow-sm p-8">
        ...
        <div class="grid md:grid-cols-2 gap-6">
            <a href="{{ route('customer.subscription') }}" class="block bg-gray-50 hover:bg-gray-100 rounded-lg p-6 transition-colors">
            ...
            <a href="{{ route('customer.invoices.index') }}" class="block bg-gray-50 hover:bg-gray-100 rounded-lg p-6 transition-colors">
                <div class="flex items-center mb-4">
                    <svg class="w-8 h-8 text-gray-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('pricing') }}" class="block bg-gray-50 hover:bg-gray-100 rounded-lg p-6 transition-colors">
                <div class="flex items-center mb-4">
                    <svg class="w-8 h-8 text-gray-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('profile.edit') }}" class="block bg-gray-50 hover:bg-gray-100 rounded-lg p-6 transition-colors">
                <div class="flex items-center mb-4">
                    <svg class="w-8 h-8 text-gray-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
